    ...
    try {
      ...
      if (stp === "playlist") {
        ...
        if (!playlist?.length > 0)
          return interaction
            .reply({ content: `There is no playlist. ❌`, ephemeral: true })
            .catch((e) => {});
          ...
          if (
            ...
            if (playlist_owner_filter !== interaction.member.id) {
              if (playlist_public_filter === false) {
                return interaction
                  .reply({
                    content: `You don't have permission to play this playlist. ❌`,
                    ephemeral: true,
                  })
                  .catch((e) => {});
              }
            ...
            if (!music_filter?.length > 0)
              return interaction
                .reply({ content: `No music with Name`, ephemeral: true })
                .catch((e) => {});

            interaction
              .reply({ content: `Loading playlist... ✅` })
              .catch((e) => {});
            ...
            if (arr === playlist.length) {
              return interaction
                .reply({ content: `There is no Album ❌`, ephemeral: true })
                .catch((e) => {});
            }
          }
        }
      ...
      if (stp === "normal") {
        ...
        if (!name) {
          return interaction
            .reply({ content: "▶️ Give Text or link", ephemeral: true })
            .catch((e) => {});
        }
